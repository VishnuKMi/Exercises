...
export const queryClient = new QueryClient() // exporting from here because we can resuse this for query-data-invalidation

export async function fetchEvents ({ signal, searchTerm, max }) {
  // 'signal' is needed so that tq can let fetch req know whether to proceed or abort.
